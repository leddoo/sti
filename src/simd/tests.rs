...
mod tests {
    ...
    fn b32x2() {
        ...
        assert_eq!(b(false, false).select_f32(f(1.0, 2.0), f(3.0, 4.0)).as_array(), [1.0, 2.0]);
        assert_eq!(b(false, true ).select_f32(f(1.0, 2.0), f(3.0, 4.0)).as_array(), [1.0, 4.0]);
        assert_eq!(b(true,  false).select_f32(f(1.0, 2.0), f(3.0, 4.0)).as_array(), [3.0, 2.0]);
        assert_eq!(b(true,  true ).select_f32(f(1.0, 2.0), f(3.0, 4.0)).as_array(), [3.0, 4.0]);
